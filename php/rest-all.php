<?php
    if(session_status() == PHP_SESSION_NONE){
        ...
        $_SESSION["ARTICLE_INFO"] = fetchInfo("https://thelasallian.com/wp-json/wp/v2/posts?_fields=jetpack_featured_media_url,date,link,title,authors,categories&tags=2115&orderby=modified&per_page=75");
